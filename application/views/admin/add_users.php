                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <hr>
                            <form action="<?php echo base_url('admin/add_users');  ?>" method="post" role="form" id="form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="User's Full Name" class="form-control" id="fullname" name="fullname" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" placeholder="User's Email" class="form-control" id="email" name="email" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="User's Phone No" class="form-control" id="phoneno" name="phoneno" required>
                                            </div>
                                        </div>

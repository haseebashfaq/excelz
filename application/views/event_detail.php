...
<?php foreach($events_specific as $event_s) { ?>
    <section class="inner_cover parallax-window event-details-header" data-parallax="scroll" data-image-src="<?php echo $event_s['EventCoverPhoto']; ?>">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-3">
                            <div class="counter_box">
                                ...
                                <h5>Ticket Price</h5>
                                <span><?php echo $event_s['Currency']; ?><?php echo $event_s['TicketPrice']; ?></span>
                    ...
                    <div class="row justify-content-center no-gutters">
                        <div class="speaker_box">
                            <div class="speaker_img ">
                                <?php if($event_spe['DisplayPicture'] == 'backend/upload/no_image.jpg') {

                                } else {
                                    $dp  = $event_spe['DisplayPicture'];
                                    echo "<img src='$dp' alt='speaker_name' style='width:370px; height:272px;'>";
                                }?>


                                <div class="info_box">
                                    <h5 class="name"><?php echo (empty($event_spe['FullName'])) ? '' : $event_spe['FullName']; ?></h5>
                                </div>
                            </div>
            ...
            <div class="row justify-content-center event-schedule-section">
                <div class="col-sm12 col-md-12 event-schedule-outer r1">
                    ...
                    <div class="col-sm3 col-md-3 event-schedule-inner">
                        <i class="fa fa-clock-o" aria-hidden="true"></i>   <?php  echo date('h:i A', strtotime($event_s['Regtimeone']));  ?>
                        <i class="fa fa-clock-o" aria-hidden="true"></i>   <?php  if($event_s['Regtimetwo'] == '00:00:00') {echo '' ;} else {echo date('h:i A', strtotime($event_s['Regtimetwo']));} ;  ?>
                        <i class="fa fa-clock-o" aria-hidden="true"></i>   <?php  if($event_s['Regtimethree'] == '00:00:00') {echo '' ;} else {echo date('h:i A', strtotime($event_s['Regtimethree'])); } ;  ?>
                    </div>
                    <div class="col-sm3 col-md-3 event-schedule-inner">
                        <div class="schedule-avatar" style="background-image: url('assets/img/speakers/male-avatar.png'); background-position: center; background-size: contain; background-repeat: no-repeat; height: 50px; width: 50px; border-radius: 50%; float: right;"></div>
                    </div>
                </div>
                <?php
                $begin = new DateTime( $event_s['StartDate'] );
                $end   = new DateTime( $event_s['Enddate'] );
                $count = 0;
                $StartTime;
                $EndTime;
                ...
                for($i = $begin; $i <= $end; $i->modify('+1 day')){
                    ...
                    if($count==1)
                    {
                        $StarTime = $event_s['Starttimeone'];
                        $EndTime = $event_s['Endtimeone'];
                    }
                    if($count==2)
                    {
                        $StarTime = $event_s['Starttimetwo'];
                        $EndTime = $event_s['Endtimetwo'];
                    }
                    if($count==3)
                    {
                        $StarTime = $event_s['Starttimethree'];
                        $EndTime = $event_s['Endtimethree'];
                    }
                    ?>

                    <div class="col-sm12 col-md-12 event-schedule-outer r2">
                        <div class="col-sm2 col-md-2 event-schedule-inner">
                            <?php    echo $i->format("d-M-Y");  ?></p>
                        </div>
                        <div class="col-4 col-md-4 event-schedule-inner">
                            Start Time
                        </div>
                        <div class="col-sm3 col-md-3 event-schedule-inner">
                            <i class="fa fa-clock-o" aria-hidden="true"></i>   <?php  if($StarTime == '00:00:00') {echo '' ;} else {echo date('h:i A', strtotime($StarTime)); } ;  ?>
                    ...
                    <div class="col-sm12 col-md-12 event-schedule-outer r3">
                        ...
                        <div class="col-sm3 col-md-3 event-schedule-inner">
                            <i class="fa fa-clock-o" aria-hidden="true"></i>   <?php  if($EndTime == '00:00:00') {echo '' ;} else {echo date('h:i A', strtotime($EndTime)); } ;  ?>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-12 text-center">
                    <a href="#" class="btn btn-primary btn-rounded mt30">Register now</a>
                </div>
            </div>
        </div>
    </section>

                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Please enter guidelines details.
                            </p>
                            <hr>
                            <form action="<?php echo base_url('admin/add_guidelines');  ?>" method="post" role="form" id="form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"> <i class="fa fa-user-o"></i> </span>
                                                <input type="text" placeholder="Answer" class="form-control" id="answer" name="answer" required>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <p>
                                            By clicking ADD Guideline, Guideline will be added.
                                        </p>
                                    </div>
                                    <div class="col-md-4">
                                        <button class="btn btn-primary btn-wide pull-right" type="submit">
                                            Add Guideline <i class="fa fa-arrow-circle-right"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>

                ...
                <div class="form-group  form-multiday">
                      <input id="endtimethree" name="endtimethree" type="text" class="form-control" placeholder="End time three (i.e. 15:00)" >
                        ...
                        <div class="location-form-itemc event-photo-radio-div">
                            <input class="location-form-itemc" type="radio" id="eventcoverphoto2" name="eventcoverphoto2"  value="https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?cs=srgb&dl=audience-celebration-concert-1190297.jpg&fm=jpg"  />
                            <img class="location-form-itemc" src="https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?cs=srgb&dl=audience-celebration-concert-1190297.jpg&fm=jpg" width="200px" height="200px" alt="I'm happy" />
                                ...
                                <input class="location-form-itemc" type="radio" id="eventcoverphoto2" name="eventcoverphoto2"  value="https://static1.squarespace.com/static/5a982ed18f51303a98d2de4d/t/5a9ed1a7c83025f018c61ae2/1520357800287/all+events.jpg?format=1500w"   />
